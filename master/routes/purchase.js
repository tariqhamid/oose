...
exports.find = function(req,res){
  var data = req.body
  Purchase.findAll({where: {sha1: data.sha1}})
    .then(function(result){
...
exports.exists = function(req,res){
  var data = req.body
  Purchase.findAll({where: {sha1: data.sha1}, include: [Prism,Store]})
    .then(function(result){
      if(!result){
        res.json({
          exists: false,
...
exports.remove = function(req,res){
  ...
  Store.find({where: {name: data.store}})
    .then(function(result){
      ...
      store = result
      return Purchase.destroy({where: {sha1: data.sha1, StoreId: store.id}})
    })
    .then(function(count){
