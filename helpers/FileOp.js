...
var FileOp = function(file,opt_peerList){
  ...
  that.peerList = opt_peerList || []
  //populate properties
  that.action = FILE_ACTIONS.nop
  that.source = ''
  that.destination = ''
   ...
   */
  that.setPeerList = function(peerList){
    that.peerList = peerList
  }
...
FileOp.prototype.FILE_ACTIONS = FILE_ACTIONS
